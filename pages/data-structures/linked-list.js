...
export default function LinkedListPage() {
  ...
  return (
    <>
      <Head>
        <title>Linked Lists - Data Structures | AlgoMania</title>
        <meta name="description" content="Interactive linked list data structure visualization" />
      </Head>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-lg ${
                ...
                Dynamic Data Structure with Nodes and Pointers - Interactive Visualization
              </p>
            </div>
