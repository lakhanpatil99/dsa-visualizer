...
export default function HeapPage() {
  ...
  return (
    <>
      <Head>
        <title>Heap - Data Structures | AlgoMania</title>
        <meta name="description" content="Interactive heap data structure visualization" />
      </Head>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-lg ${
                ...
                Complete Binary Tree with Heap Property - Interactive Visualization
              </p>
            </div>
