...
export default function QueuePage() {
  ...
  return (
    <>
      <Head>
        <title>Queue - Data Structures | AlgoMania</title>
        <meta name="description" content="Interactive queue data structure visualization" />
      </Head>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-lg ${
                ...
                FIFO (First In, First Out) - Interactive Visualization
              </p>
            </div>
