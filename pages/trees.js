...
import TreeVisualizer from '../src/pages/TreeVisualizer';
...
export default function Trees() {
  ...
  return (
    <>
      <Head>
        <title>Trees - AlgoMania</title>
        <meta name="description" content="Interactive tree data structure visualizations" />
      </Head>
      ...
      <div className={`min-h-screen transition-all duration-300 ${isDarkMode ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
        ...
        {/* Main Content Area - Your Actual TreeVisualizer */}
