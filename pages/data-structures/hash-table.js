...
export default function HashTablePage() {
  ...
  return (
    <>
      <Head>
        <title>Hash Table - Data Structures | AlgoMania</title>
        <meta name="description" content="Interactive hash table data structure visualization" />
      </Head>
      ...
      <div className={`min-h-screen transition-all duration-300 ${isDarkMode ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-lg ${
                ...
                Key-Value Pair Data Structure - Interactive Visualization
              </p>
            </div>
        ...
        <div className={`px-6 py-3 border-b ${
          ...
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span>/</span>
            <span className="font-medium">Hash Table</span>
          </div>
        </div>
